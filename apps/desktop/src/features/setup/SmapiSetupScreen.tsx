      ...
      <Card className="space-y-5">
        <div className="flex items-center justify-between border-b border-[var(--border)] pb-4">
          <div>
            ...
            <p className="text-xs text-[var(--fg-muted)]">Official release for Stardew Valley 1.6.9+</p>
          </div>
        ...
        <div className="space-y-2 text-xs text-[var(--fg-muted)] font-mono bg-[var(--bg-primary)] p-3 rounded-lg border border-[var(--border)]">
          <div>SHA-256: 8c127148a76c890e485aea73910189dc41c80f822c2a0a5e3b0e762b4ee3a93e</div>
          <div>Target: {game.canonical_root}</div>
        </div>

        {isInstalling && <p role="status">Installing SMAPI and checking installed files. This may take a few minutes.</p>}
